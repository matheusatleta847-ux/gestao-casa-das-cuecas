...
# --- 1. CONFIGURAÇÃO E CSS (O ESTILO QUE VOCÊ GOSTOU) ---
...
st.markdown("""
    ...
    .stButton > button[kind="primary"] {
        ...
        border-left: 8px solid #0073EA !important; /* A barrinha azul que você pediu */
    }
    ...
    with c_f:
        ...
        for idx, v in fila.iterrows():
            ...
            if st.session_state.get(f"p_{v['id']}", False):
                mot_p = st.selectbox("Motivo Saída:", ["Almoço", "Banheiro", "Café", "Fim de Turno"], key=f"s_p_{v['id']}")
